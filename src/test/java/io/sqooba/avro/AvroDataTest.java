...
import static io.sqooba.avro.AvroData.AVRO_TYPE_ENUM;
import static io.sqooba.avro.AvroData.CONNECT_ENUM_DOC_PROP;
import static io.sqooba.avro.AvroData.CONNECT_RECORD_DOC_PROP;
import static io.sqooba.avro.AvroDataConfig.AvroDataConfigBuilder.anAvroDataConfig;
...
public class AvroDataTest {
  ...
  public void testFromConnectEnum() {
    AvroDataConfig avroDataConfig = anAvroDataConfig()
  ...
  public void testFromConnectComplex() {
    ...
    org.apache.avro.generic.GenericRecord avroRecord
        ...
        .set("mapNonStringKeys", Collections.singletonList(
  ...
  public void testToConnectUnionWithEnhanced() {
    avroData = new AvroData(anAvroDataConfig()
        .withSchemasCacheSize(2)
        .withEnhancedAvroSchemaSupport(true)
        .build());
    // Make sure we handle primitive types and named types properly by using a variety of types
    org.apache.avro.Schema avroRecordSchema1 = org.apache.avro.SchemaBuilder.builder()
